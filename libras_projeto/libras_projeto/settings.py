...
SECRET_KEY = 'django-insecure-+sl0otdyoovac)dzi$o)qerxmxf-mttl1tzwns@iviqd3_@i^$'
...
ROOT_URLCONF = 'libras_projeto.urls'
...
WSGI_APPLICATION = 'libras_projeto.wsgi.application'
